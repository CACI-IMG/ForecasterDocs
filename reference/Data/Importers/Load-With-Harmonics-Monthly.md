...
# *Load With Harmonics - Monthly* Script Importer

This section covers how to use the *Load With Harmonics - Monthly* importer. 

Once *Load With Harmonics - Monthly* is selected from the drop-down at the top of the Script Selector dialog, you should see the parameters as shown below. You'll need to browse for the csv file to be read in, but apart from that you can very often run with the default parameters without needing to change anything else. The parameters and their effects are described here, but these details can also be found by hovering over the blue **(i)** icon in front of each parameter name.

![Load With Harmonics Monthly](imgs/ScriptImporter_LoadWithHarmonicsMonthly.png) 

## *Load With Harmonics - Monthly* parameters
